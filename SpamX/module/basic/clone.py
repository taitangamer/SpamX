...
from SpamX.helper.basic import edit_or_reply, get_text, get_user

from SpamX.modules.help import *

OWNER = os.environ.get("OWNER", None)
BIO = os.environ.get("BIO", "ᴘᴀʀᴛ ᴏғ ᴠᴇɴᴏᴍ ᴜsᴇʀʙᴏᴛ")
...
async def clone(client: Client, message: Message):
    ...
    await message.edit(f"**ғʀᴏᴍ ɴᴏᴡ ɪ'ᴍ** __{f_name}__")
