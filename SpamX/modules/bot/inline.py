...
from SpamX import CMD_HELP, StartTime, app
from SpamX.helper.data import Data
from SpamX.helper.inline import inline_wrapper, paginate_help
...
"""
    answers.append(
        InlineQueryResultArticle(
            ...
            thumb_url="https://telegra.ph/file/3b9730e0042579e85c243.jpg",
...
async def help_function(answers):
    ...
    answers.append(
        InlineQueryResultArticle(
            ...
            thumb_url="https://telegra.ph/file/17ded061a4ae0833a77b7.jpg",
            input_message_content=InputTextMessageContent(
